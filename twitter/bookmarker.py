...
class TwitterBookmarkDownloader(object):
    ...
    #   tweet = self.browser.find_element_by_xpath("//*[@id='react-root']/div/div/div[2]/main/div/div/div/div[1]/div/div[2]/div/section/div/div/div")
        ...
        # remove bookmark
        # dropdown = tweet.find_element_by_css_selector("div[data-testid='Dropdown']")
        # dropdown.find_element_by_css_selector("div[role='menuItem']:last-child").click()
        # tweet.find_element_by_xpath('//*[@id="layers"]/div[2]/div/div/div/div[2]/div[3]/div/div/div/div[2]').click()
        tweet.find_element_by_xpath('//*[@id="layers"]/div[2]/div/div/div/div[2]/div/div[3]/div/div/div/div[3]').click()
